...
namespace UnityEditor.UI
{
    ...
    public class MaskedImageEditor : GraphicEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            m_MaskContent = EditorGUIUtility.TrTextContent("Mask Image");
        ...
        protected void SpriteGUI()
        {
            ...
            EditorGUILayout.PropertyField(Mask, m_MaskContent);
