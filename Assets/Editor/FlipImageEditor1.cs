...
namespace UnityEditor.UI
{
    ...
    /// </summary>
    public class FlipImageEditor : GraphicEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            VerticalContent = EditorGUIUtility.TrTextContent("VerticalContent");
        ...
        protected void SpriteGUI()
        {
            ...
            EditorGUILayout.PropertyField(Vertical, VerticalContent);
